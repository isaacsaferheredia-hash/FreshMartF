<x-adminlayout title="Nuevo Proveedor">
            ...
            <div class="col-lg-8 col-md-10">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h4 class="fw-bold mb-1">Registrar Proveedor</h4>
                        <p class="text-muted mb-4">
                            Ingreso de nuevo proveedor al sistema
                        </p>
                        ...
                        <form method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="prv_direccion"
                                          ...
                                          required>{{ old('prv_direccion') }}</textarea>
                                @error('prv_direccion')
                                <div class="invalid-feedback">
